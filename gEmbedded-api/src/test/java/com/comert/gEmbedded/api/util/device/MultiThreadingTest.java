package com.comert.gEmbedded.api.util.device;
...
public class MultiThreadingTest {
    ...
    public synchronized static <I> int instanceSize(InstanceProcuder<I> procuder) throws InterruptedException {
        Set<I> instanceSet = Collections.synchronizedSet(new HashSet<>());

        Runnable runnable = () -> {
            I instance = procuder.getInsance();
